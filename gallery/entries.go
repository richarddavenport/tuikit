...
func (m *Model) keysEntry(s *styles) Entry {
	...
	return Entry{
		...
		States: []State{
			...
			{Name: "too short", Note: "says it was cut, and HOW MANY — a help screen that quietly omits half the keys is worse, because a reader believes it",
				Draw: draw(comp.Keys{Sections: full}, 6)},
			{Name: "scrolled", Note: "Offset is how a reader reaches them; saying \"more\" without one is the least helpful state a help screen has (issue 50)",
				Draw: draw(comp.Keys{Sections: full, Offset: 6}, 6)},
